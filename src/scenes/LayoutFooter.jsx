...
const LayoutFooter = () => {
    ...
    /**
     * TODO: Pages Plan du site, CGU, Mentions légales 
     */
        ...
        return (<Footer className="rs-footer bg-[#fcfcfc]">
            <div className='bg-footer_wave bg-cover h-20 bg-no-repeat flex flex-col items-center justify-end'>
                <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center sm:justify-around w-full lg:w-[800px] mx-auto">
                    <a className="text-neutral-100 visited:text-neutral-100" href="acceuil">Plan du site</a>
                    <a className="text-neutral-100 visited:text-neutral-100" href="acceuil">Conditions générales d'utilisation</a>
                    <a className="text-neutral-100 visited:text-neutral-100" href="acceuil">Mentions légales</a>
                </div>
                <div className=" relative">
                    <p className='text-center text-neutral-100 p-1'>© Copyright Centre Afpa de Rochefort. Tous droits réservés.</p>
                </div>
            </div>
        </Footer>);
    } else {
